  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-[460px_1fr] bg-slate-950 font-sans text-slate-200 antialiased overflow-hidden">
      ...
      <div className="flex flex-col justify-between p-6 bg-slate-900 border-r border-slate-800/80">
        ...
        <div className="w-full py-4">
          <div className="mb-5">
            ...
            <p className="text-xs text-slate-400 mt-0.5">Initialize your secure telemetry workspace board layer</p>
          </div>

          <form onSubmit={submit} className="space-y-3.5">
            {error && (
              <div className="p-2.5 bg-red-950/40 text-red-400 rounded-lg text-xs font-medium border border-red-100/10 leading-normal">
                {error}
              </div>
            )}
            ...
            <div>
              <label className="block mb-1 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Password</label>
              <input
                type="password"
                className="w-full px-3 py-2 bg-slate-950 border border-slate-800 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-xs transition-all text-slate-200 placeholder:text-slate-600"
                value={password}
          ...
          <div className="mt-4 pt-4 border-t border-slate-800/60 text-center text-xs text-slate-400">
            Already have an active slice? 
            <Link to="/login" className="text-blue-400 hover:text-blue-300 ml-1 font-semibold transition-colors">
              Sign In
            </Link>
          </div>
        </div>
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
        ...
        {/* 🚀 THE ILLUSTRATIVE WORKFLOW ELEMENT */}
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="border border-slate-800 rounded-xl p-3 bg-slate-950/40">
              ...
              <div className="space-y-2">
                ...
                <div className="bg-slate-900 border border-slate-800 p-2 rounded-lg opacity-60">
            ...
            <div className="border border-blue-900/30 rounded-xl p-3 bg-slate-950/40 ring-1 ring-blue-500/10">
              ...
              <div className="space-y-2">
                <div className="bg-slate-900 border border-blue-900/40 p-2 rounded-lg shadow-lg shadow-blue-950/20">
        ...
        <div className="relative z-10 max-w-md">
          <div className="text-blue-500 text-xs font-bold font-mono tracking-widest uppercase mb-1">// ROW_LEVEL_SECURITY</div>
          <h2 className="text-lg font-bold text-white tracking-tight">Zero Shared Context Architecture</h2>
          <p className="text-xs text-slate-400 leading-relaxed mt-1">
            Data mutations are structurally isolated per token signature. Workspace rows filter at the database engine level to eliminate cross-account leakage.
          </p>
        </div>
      </div>
    </div>
